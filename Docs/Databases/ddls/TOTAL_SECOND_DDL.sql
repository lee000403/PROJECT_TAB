...
ALTER TABLE MEMBER_F
  ADD CONSTRAINT FK_DEMENTIA_STAGE_TO_MEMBER_F
...
ALTER TABLE MATCHING_A
  ADD CONSTRAINT FK_SURVEY_RESULT_TO_MATCHING_A
    FOREIGN KEY (SURVEY_RESULT_ID)
    REFERENCES SURVEY_RESULT (A_RESULT_ID);
...
ALTER TABLE MEMBER_F
  ADD CONSTRAINT FK_MEMBERTYPE_TO_MEMBER_F
    FOREIGN KEY (MEMBERTYPE_ID)
    REFERENCES MEMBERTYPE (MEMBERTYPE_ID);
